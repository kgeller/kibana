...
import {
  ...
  SEARCH_AI_LAKE_PUBLICIZED_PACKAGES,
...
export function getAllowedSearchAiLakeInstallPackages() {
  // todo real val check
  return true
    ? SEARCH_AI_LAKE_PUBLICIZED_PACKAGES.concat(SEARCH_AI_LAKE_ALLOWED_INSTALL_PACKAGES)
    : undefined;
}
