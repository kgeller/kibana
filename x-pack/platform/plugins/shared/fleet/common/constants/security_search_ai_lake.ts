 ...
 */
export const SEARCH_AI_LAKE_PUBLICIZED_PACKAGES = [
  'crowdstrike',
  'google_secops',
  'microsoft_sentinel',
  'sentinel_one',
...
/**
 * Allowlist of integrations in addition to {@link SEARCH_AI_LAKE_ALLOWED_INSTALL_PACKAGES} which are available to
 * install in the Serverless Security SearchAILake tier (AI4DSOC effort).
 */
export const SEARCH_AI_LAKE_ALLOWED_INSTALL_PACKAGES = [
  'elastic_connectors',
  // 'file_data_visualizer',    ---> figure out non-epr integrations
